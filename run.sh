...
v4l2-ctl --set-ctrl=rotate=180 -c auto_exposure=1 -c exposure_time_absolute=100 -c white_balance_auto_preset=0 
v4l2-ctl -c iso_sensitivity_auto=0 -c iso_sensitivity=0 
v4l2-ctl -c exposure_metering_mode=2 -c brightness=20 -c saturation=100
